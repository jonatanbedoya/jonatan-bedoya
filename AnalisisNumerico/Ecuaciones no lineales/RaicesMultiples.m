function RaicesMultiples
  ...
  str_fucn2=input("Por favor ingrese su primera derivada:  ","s");
  fucn_sym=sym(str_fucn2);
  df=function_handle(fucn_sym);
  str_fucn3=input("Por favor ingrese su segunda derivada:  ","s");
  fucn_sym=sym(str_fucn3);
  ddf=function_handle(fucn_sym);
